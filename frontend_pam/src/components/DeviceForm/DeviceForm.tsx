      ...
      <div className="grid grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input id="date" placeholder="Enter date" type="date" {...register("date")} />
            {errors.date && <p className="text-sm text-red-500">{errors.date.message}</p>}
          </div>
          <div className="space-y-2">
            <Label htmlFor="time">Time (UTC)</Label>
            <Input id="time" placeholder="Enter time" type="time" {...register("time")} />
            {errors.time && <p className="text-sm text-red-500">{errors.time.message}</p>}
          </div>
          <div className="space-y-2">
            <Label htmlFor="latitude">Latitude</Label>
            <Input id="latitude" placeholder="Enter latitude" type="number" {...register("latitude")} />
            {errors.latitude && <p className="text-sm text-red-500">{errors.latitude.message}</p>}
          </div>
          <div className="space-y-2">
            <Label htmlFor="longitude">Longitude</Label>
            <Input id="longitude" placeholder="Enter longitude" type="number" {...register("longitude")} />
          ...
          <div className="space-y-2">
            ...
            <Input id="coordUncertainty" placeholder="Enter coordinate uncertainty" type="number" {...register("coordUncertainty")} />
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <Input id="micHeight" placeholder="Enter microphone height" type="number" {...register("micHeight")} />
          ...
          <div className="space-y-2">
            ...
            <Input id="score" placeholder="Enter score" type="number" {...register("score")} />
          ...
          <div className="space-y-2">
            ...
            <Input id="sdCardSize" placeholder="Enter SD Card Size" type="number" {...register("sdCardSize")} />
